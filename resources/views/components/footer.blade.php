        ...
        <footer class="row row-cols-1 row-cols-sm-2 row-cols-md-5 my-5">
            ...
            <div class="col mb-3 quickLinkDiv">
                ...
                <ul class="nav flex-column quickLinks">
                    ...
                    <li class="nav-item mb-2 "><a href="{{ route('displayDaftarArtikel', ['id' => $id]) }}" id="artikelLink">Artikel</a></li>
                    <li class="nav-item mb-2 "><a href="{{ route('displayDaftarForum', ['id' => $id]) }}" id="forumLink">Forum</a></li>
