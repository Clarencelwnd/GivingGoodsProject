...
@section('content')
    <div class="container" style="display: flex; justify-content: center; width: 100%; margin: auto; margin-bottom: 30px;">
        <div class="card-body">
            ...
            <form action="{{route('change_password_logic.panti_sosial', ['id'=>$id])}}" class= "form" role="form" autocomplete="off" method="post">
                ...
                <div class="d-flex justify-content-end" id="button-style">
                    <a data-bs-toggle="modal" data-bs-target="#exitChangePasswordModal" class="btn btn-cancel d-flex align-items-center" id="exitChangePassword">Batal</a>
