                ...
                <div class="card justify-content-center">
                    <div class="card-body">
                        ...
                        <form action="" class="text">
                            ...
                            <button type="button" class="btn px-4 me-md-2 fw-normal" id="btn-next">
                                Verifikasi
                            </button>
                        </form>
                        <a href="#" class="btn btn-block" id="btn-back">Kembali</a>
                    </div>
                </div>
    ...
    <script>
        ...
        function countdown(){
            ...
            if(timer < 0){
                ...
                document.getElementById('kirim-ulang').innerHTML = "Tidak menerima kode? Kirim ulang";
            }
        }
