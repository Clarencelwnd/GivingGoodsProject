...
class drDetailKegiatanRelawanController extends Controller
{
    ...
    public function show($idKegiatanRelawan, $idDonaturRelawan)
    {
        ...
        $id = $idDonaturRelawan;
            ...
            $coordinatesPantiSosial = $this->getCoordinatesFromGoogleMapsLink($kegiatanRelawan->LinkGoogleMapsLokasiKegiatanRelawan);
        ...
        return view('DetailKegiatanRelawan.drDetailKegiatanRelawan', compact('kegiatanRelawan', 'donaturRelawan', 'jarakKm', 'id'));
    }
